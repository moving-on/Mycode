...
#include"construct.h"
	...
	inline ForwardIterator myuninitialized_fill_n(ForwardIterator first, Size n, const T& x)
	{
	...
	inline ForwardIterator myuninitialized_copy(InputIterator first, InputIterator last, ForwardIterator result)
	{
	...
	inline void myuninitialized_fill(ForwardIterator first, ForwardIterator last, const T& x)
	{
